      ...
      >
        <div className="flex flex-col p-4 sm:mx-auto sm:max-w-[720px] xl:max-w-[1920px] xl:p-0">
          ...
          <div className="mt-4 xl:flex xl:flex-row-reverse xl:items-center xl:justify-between xl:pt-24 xl:p-6 ">
            <div
              id="sponsors"
              className="flex  flex-col items-center space-y-2 m-2 w-full mx-auto border border-[#4c4c4c] pt-6 xl:border-none"
            >
              <div className="flex w-full  justify-around xl:px-[60px] 2xl:px-[120px]">
                <a
                  href="https://www.nfl.com/super-bowl/event-info/opening-night/"
                  target="_blank"
                  className="flex  flex-col items-center justify-start hover:scale-[105%] transition duration-300 ease-in-out"
                >
                  <img
                    className="max-w-[60%]  sm:w-[60%]"
                    src="/img/M_OpNight.png"
                    alt="Opening Night"
                  />
                </a>
                <a
                  href="https://www.nfl.com/super-bowl/event-info/super-bowl-experience/"
                  target="_blank"
                  className="flex  flex-col items-center justify-start hover:scale-[105%] transition duration-300 ease-in-out"
                >
                  <img
                    className="max-w-[70%] sm:w-[60%]"
                    src="/img/M_Toyota.png"
                    alt="Toyota"
                  />
                </a>
              </div>
              <div className="py-6 flex flex-col items-center justify-center hover:scale-[105%] transition duration-300 ease-in-out xl:py-12">
                <img
                  className="w-[40%] sm:w-[60%] xl:w-[65%] 3xl:w-[80%]"
                  src="/img/VZ_Live Logo.png"
                  alt="Verizon Live"
                />
              </div>
            </div>
            <div
              id="copy"
              className="px-4 py-6 space-y-6 sm:flex flex-col  items-start sm:w-80 xl:w-[60%]"
            >
              <div id="header2" className="">
                ...
                <p className="hidden font-verizonBold xl:inline tracking-wide text-white xl:text-7xl xl:leading-[4.5rem] xl:max-w-[9ch]">
                  Attend
                  <br />
                  the biggest Super Bowl LVIII events.
                </p>
              </div>
              ...
              <div className="">
                <p className="text-lg leading-none font-verizonFont opacity-9 max-w-[26ch] text-white sm:text-md xl:text-2xl xl:leading-none xl:max-w-[35ch]">
                  Fans and small business owners,
                  <br />
                  visit a participating Verizon retail location and make a
                  qualifying purchase to get tickets to NFL&nbsp;Opening
                  Night&#44; Super Bowl Experience and&nbsp;the Verizon Lounge.
                </p>
              </div>
          ...
          <div id="terms" className="p-4 sm:px-10 xl:pt-12 xl:pb-16">
            <p className="text-[7px] leading-none text-accent1 font-verizonFont xl:hidden">
              ...
              connection with participation in this Sweepstakes or any prize
              awarded. The NFL Entities have not offered or sponsored this
              sweepstakes in any way.
              <br></br>
              <br></br>
              <span className="text-accent2">
              ...
              for participating locations and offer period. SPONSOR: Verizon Wireless&#44; One Verizon Way&#44; Basking Ridge&#44; NJ 07920.
              <br></br>
              <br></br>
              <a
                className="underline cursor-pointer"
